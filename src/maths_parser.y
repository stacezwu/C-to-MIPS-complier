...
%left OP_DECREMENT OP_INCREMENT
...
DECLARATION : SPECIFIERS T_IDENTIFIER T_SEMICOLON { $$ = new Declaration($1, $2, NULL); }
            ...
            // | SPECIFIERS T_IDENTIFIER OP_L_SQUAREBRACKET OP_R_SQUAREBRACKET T_SEMICOLON { $$ = new ArrayDeclaration($1, $2, NULL, NULL); }
            | ENUM_SPECIFIER T_SEMICOLON { $$ = $1; }
            | ENUM_SPECIFIER T_IDENTIFIER T_SEMICOLON { $$ = new EnumDeclaration($1, $2, NULL); }
            | ENUM_SPECIFIER T_IDENTIFIER OP_EQ EXPR T_SEMICOLON { $$ = new EnumDeclaration($1, $2, $4); }
            | ENUM_SPECIFIER T_IDENTIFIER OP_EQ VARIABLE T_SEMICOLON { $$ = new EnumDeclaration($1, $2, $4); }
//            | T_IDENTIFIER OP_LBRACKET OP_RBRACKET T_SEMICOLON { $$ = new FunctionDeclaration(new ASTSpecifierList("int"), $1, NULL); } // implicit return type (TODO: temporarily commented out due to shift reduce error)
            ...
            // TODO: implement comma separated initializers
