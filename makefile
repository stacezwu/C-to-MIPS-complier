...
all : bin/print_mips bin/print_canonical bin/eval_expr
...
bin/print_mips : src/print_mips.o src/maths_parser.tab.o src/maths_lexer.yy.o src/maths_parser.tab.o
	mkdir -p bin
